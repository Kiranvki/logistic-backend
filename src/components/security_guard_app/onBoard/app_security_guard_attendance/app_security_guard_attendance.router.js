...
const {
  ...
  securityGenerateMonthDaysAndOtherMetaData, // generate month days and other meta data
} = require("../../../../hooks/app");
...
function userRoutes() {
  return (open, closed, appOpen, appClosed) => {
    ...
    closed.route("/user/attendance/month/:month/year/:year").get(
       ...
       verifySecurityAppToken, // verify app token
       isValidSecurityGuardId, // validate salesman Id
       securityGenerateMonthDaysAndOtherMetaData, // generate month days and other metadata
      ctrl.getSecurityUserAttendanceForAMonth // controller function
    );
