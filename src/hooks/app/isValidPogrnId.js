// Controller
const poGRNCtrl = require("../../components/picker_app/external_purchase_order/purchase_orderGRN/purchase_orderGRN.controller");
...
module.exports = async (req, res, next) => {
  try {
    ...
    if (objectId.isValid(grnId)) {
      ...
      let grnDet = await poGRNCtrl.get({
      ...
      if (grnDet.success) {
        ...
        return Response.errors(
          ...
          MessageTypes.purchaseOrder.grnRecordNotExist
        );
      }
    } else {
      ...
      return Response.errors(
        ...
        res,
        StatusCodes.HTTP_CONFLICT,
        MessageTypes.purchaseOrder.invalidPurchaseOrderGRNId
      );
    }
