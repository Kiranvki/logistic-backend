...
module.exports = {
  ...
  isvalidImageIsUploading:require('./isvalidImageIsUploading'),
  isValidProfilePicUpload: require('./isValidProfilePicUpload'), // check whether the profile pic is valid or not 
