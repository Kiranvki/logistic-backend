const securityUserSessionCtrl = require('../../../components/security_guard_app/onBoard/app_security_guard_user_session/app_security_guard_user_session.controller'); // user controller 
...
module.exports = async (req, res, next) => {
  try {
    ...
    if (payload && payload.data && JSON.parse(payload.data)) {
      ...
      //   success: true
      // };
      let isValidUserSession = await securityUserSessionCtrl.getUserToken(data._id); // UNCOMMEMT FOR PROD
